...
\centerline{\includegraphics[scale=0.75]{1_Presentation/1.1_Our_project_Dan/tree}}
  \caption{An exploring tree : \newline The probabilities related to the nodes are the numbers, so the best node is the node B according to the statistics. See more in part  use \ref{trees}.} %centering caption \ref{nameOfSection} (and \label{nameOfSection})
  \centering
\end{figure}
