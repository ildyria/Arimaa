...
The following figure\ref{fig:MCTSAlgorithm} represents the order of calls for the main function and provides some details about the implementation.
\begin{figure}[H]
