...
\section{General Architecture}					\label{sec:generalArchitecture}
	...
	\input{2General_Architecture/2.1Behaviour_of_the_Game/GameBehaviour.tex}
...
\section{Algorithmic methods}					\label{sec:algorithmicMethods}
	...
	\input{3Methods/3.1Parallelization_Method/paraways.tex}
...
\section{Conclusion}							\label{sec:conclusion}
	\input{5Conclusion/Conclusion.tex}
\newpage
