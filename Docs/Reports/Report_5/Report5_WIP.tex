...
\newpage
	\section{Achievements with respect to conceptualisation}			\label{sec:compare}			\input{Compare/text.tex}

\newpage
  \section{Optimisations and results}        \label{sec:optimisations}    \input{Optimisations/text.tex}
\newpage
  \section{Implementation of distribution}        \label{sec:distribution}    \input{Distribution/text.tex}
\newpage
