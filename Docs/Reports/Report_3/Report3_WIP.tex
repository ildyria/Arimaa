...
\section{Planning Methods} \label{sec:PlanningMethods}
	\subsection{Presentation Methods}		\label{sec:PresentationMethods}		%	\input{PlanningMethods/PresentationMethods/mcts.tex}
	\subsection{Environnement}			\label{sec:environnement}	%	\input{PlanningMethods/Environnement/paraways.tex}
\newpage

\section{Task Planning}					\label{sec:generalArchitecture} 		
	\subsection{Tasks list for Gant diagram}			\label{sec:Gantt}	%	\input{TasksPlanning/GanttDiagram/GameBehaviour.tex}
	\subsection{Risks analysis}		\label{sec:Risks}		%	\input{TasksPlanning/RiskAnalysis/generalView.tex}
\newpage
