...
namespace api_v2
{
	...
	public:
		 ...
		 * \return _lastMove
		 */
		void setLastMove(u_long lm);
		
		/**
		 * \fn setState(std::vector<u_long> state) 
		 * \brief setter for the bitboard
		 */
		void setState(std::vector<u_long> state);

		/**
		 * \fn getState() 
		 * \brief getter for the bitboard
		 */
		...
		/** \fn displayASCII
		 *	\details print the Bitboard in Ascii
		 */
		void displayASCII();
