...
public:
	 ...
	 */
	inline bool move(Square pos, Square dest, bool applyDeaths = true) { Move m(pos, dest); return play(m, applyDeaths); }
	/**
	 ...
	 */
	inline bool displace(Square pos, Square dest, Square target, bool applyDeaths = true) { Displace d(pos, dest, target); return play(d, applyDeaths); }
